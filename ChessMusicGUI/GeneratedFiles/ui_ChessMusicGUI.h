...
public:
    ...
    void setupUi(QWidget *ChessMusicGUIClass)
    {
        ...
        formLayout_2->setWidget(0, QFormLayout::LabelRole, threatened_guarded_pieces_label);
        ...
        formLayout_2->setWidget(1, QFormLayout::LabelRole, threatened_guarded_pieces_count_label);
        ...
        formLayout_2->setWidget(3, QFormLayout::LabelRole, unopposed_threats_count_label);
        ...
        formLayout_2->setWidget(0, QFormLayout::FieldRole, threatened_guarded_pieces_lineEdit);
        ...
        formLayout_2->setWidget(1, QFormLayout::FieldRole, threatened_guarded_pieces_count_lineEdit);
        ...
        formLayout_2->setWidget(3, QFormLayout::FieldRole, unopposed_threats_count_lineEdit);
        ...
        formLayout_2->setWidget(2, QFormLayout::FieldRole, unopposed_threats_lineEdit);
        ...
        formLayout_2->setWidget(2, QFormLayout::LabelRole, unopposed_threats_label);
        ...
        formLayout->setWidget(6, QFormLayout::LabelRole, best_move_score_label);
        ...
        formLayout->setWidget(6, QFormLayout::FieldRole, best_move_score_lineEdit);
        ...
        formLayout->setWidget(7, QFormLayout::LabelRole, best_move_score_difference_label);
        ...
        formLayout->setWidget(7, QFormLayout::FieldRole, best_move_score_difference_lineEdit);
        ...
        formLayout->setWidget(8, QFormLayout::LabelRole, best_move_score_difference_category_label);
        ...
        formLayout->setWidget(10, QFormLayout::FieldRole, is_capture_lineEdit);

        is_castling_label = new QLabel(ChessMusicGUIClass);
        is_castling_label->setObjectName(QString::fromUtf8("is_castling_label"));

        formLayout->setWidget(11, QFormLayout::LabelRole, is_castling_label);
        ...
        formLayout->setWidget(12, QFormLayout::LabelRole, possible_moves_count_label);
        ...
        formLayout->setWidget(12, QFormLayout::FieldRole, possible_moves_count_lineEdit);
        ...
        formLayout->setWidget(13, QFormLayout::LabelRole, is_capture_count_label);
        ...
        formLayout->setWidget(15, QFormLayout::LabelRole, attackers_count_label);
        ...
        formLayout->setWidget(15, QFormLayout::FieldRole, attackers_count_lineEdit);
        ...
        formLayout->setWidget(16, QFormLayout::LabelRole, threatened_pieces_label);
        ...
        formLayout->setWidget(16, QFormLayout::FieldRole, threatened_pieces_lineEdit);
        ...
        formLayout->setWidget(17, QFormLayout::LabelRole, threatened_pieces_count_label);
        ...
        formLayout->setWidget(19, QFormLayout::FieldRole, guards_count_lineEdit);
        ...
        formLayout->setWidget(20, QFormLayout::LabelRole, guarded_pieces_label);
        ...
        formLayout->setWidget(20, QFormLayout::FieldRole, guarded_pieces_lineEdit);
        ...
        formLayout->setWidget(21, QFormLayout::LabelRole, guarded_pieces_count_label);
        ...
        formLayout->setWidget(21, QFormLayout::FieldRole, guarded_pieces_count_lineEdit);
        ...
        formLayout->setWidget(11, QFormLayout::FieldRole, is_castling_lineEdit);
