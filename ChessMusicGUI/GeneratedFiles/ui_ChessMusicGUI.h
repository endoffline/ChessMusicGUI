...
public:
    ...
    void setupUi(QWidget *ChessMusicGUIClass)
    {
        ...
        formLayout->setWidget(7, QFormLayout::LabelRole, move_count_label);
        ...
        formLayout->setWidget(9, QFormLayout::LabelRole, best_move_score_label);
        ...
        formLayout->setWidget(9, QFormLayout::FieldRole, best_move_score_lineEdit);
        ...
        formLayout->setWidget(10, QFormLayout::LabelRole, best_move_score_difference_label);
        ...
        formLayout->setWidget(10, QFormLayout::FieldRole, best_move_score_difference_lineEdit);
        ...
        formLayout->setWidget(11, QFormLayout::LabelRole, best_move_score_difference_category_label);
        ...
        formLayout->setWidget(13, QFormLayout::FieldRole, is_capture_lineEdit);

        is_castling_label = new QLabel(ChessMusicGUIClass);
        is_castling_label->setObjectName(QString::fromUtf8("is_castling_label"));

        formLayout->setWidget(14, QFormLayout::LabelRole, is_castling_label);
        ...
        formLayout->setWidget(14, QFormLayout::FieldRole, is_castling_lineEdit);
        ...
        formLayout->setWidget(15, QFormLayout::LabelRole, possible_moves_count_label);
        ...
        formLayout->setWidget(15, QFormLayout::FieldRole, possible_moves_count_lineEdit);
        ...
        formLayout->setWidget(16, QFormLayout::LabelRole, is_capture_count_label);
        ...
        formLayout->setWidget(16, QFormLayout::FieldRole, is_capture_count_lineEdit);
        ...
        formLayout->setWidget(5, QFormLayout::FieldRole, score_shift_lineEdit);
        ...
        formLayout->setWidget(6, QFormLayout::FieldRole, score_shift_category_lineEdit);

        score_shift_label = new QLabel(ChessMusicGUIClass);
        score_shift_label->setObjectName(QString::fromUtf8("score_shift_label"));

        formLayout->setWidget(5, QFormLayout::LabelRole, score_shift_label);
        ...
        formLayout->setWidget(6, QFormLayout::LabelRole, score_shift_category_label);
        ...
        formLayout_2->setWidget(25, QFormLayout::LabelRole, unopposed_threats_black_label);
        ...
        formLayout_2->setWidget(25, QFormLayout::FieldRole, unopposed_threats_black_lineEdit);
        ...
        formLayout_2->setWidget(12, QFormLayout::LabelRole, unopposed_threats_white_label);
        ...
        formLayout_2->setWidget(12, QFormLayout::FieldRole, unopposed_threats_white_lineEdit);
    ...
    void retranslateUi(QWidget *ChessMusicGUIClass)
    {
        ...
        unopposed_threats_black_label->setText(QApplication::translate("ChessMusicGUIClass", "Unopposed threats", nullptr));
        ...
        unopposed_threats_white_label->setText(QApplication::translate("ChessMusicGUIClass", "Unopposed threats", nullptr));
