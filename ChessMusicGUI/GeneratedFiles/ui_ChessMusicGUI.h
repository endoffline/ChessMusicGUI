...
public:
    ...
    void setupUi(QWidget *ChessMusicGUIClass)
    {
        ...
        formLayout->setWidget(6, QFormLayout::LabelRole, fullmove_number_label);
        ...
        formLayout->setWidget(15, QFormLayout::LabelRole, best_move_score_label);
        ...
        formLayout->setWidget(15, QFormLayout::FieldRole, best_move_score_lineEdit);
        ...
        formLayout->setWidget(16, QFormLayout::LabelRole, best_move_score_difference_label);
        ...
        formLayout->setWidget(20, QFormLayout::FieldRole, is_castling_lineEdit);
        ...
        formLayout->setWidget(22, QFormLayout::LabelRole, is_capture_count_label);
        ...
        formLayout->setWidget(22, QFormLayout::FieldRole, is_capture_count_lineEdit);
        ...
        formLayout->setWidget(12, QFormLayout::FieldRole, score_shift_category_lineEdit);
        ...
        formLayout->setWidget(12, QFormLayout::LabelRole, score_shift_category_label);

        score_shift_label = new QLabel(ChessMusicGUIClass);
        score_shift_label->setObjectName(QString::fromUtf8("score_shift_label"));

        formLayout->setWidget(0, QFormLayout::LabelRole, score_shift_label);
        ...
        formLayout->setWidget(0, QFormLayout::FieldRole, score_shift_lineEdit);
        ...
        formLayout->setWidget(1, QFormLayout::LabelRole, best_move_score_difference_category_label);
        ...
        formLayout->setWidget(1, QFormLayout::FieldRole, best_move_score_difference_category_lineEdit);

        is_capture_label = new QLabel(ChessMusicGUIClass);
        is_capture_label->setObjectName(QString::fromUtf8("is_capture_label"));

        formLayout->setWidget(2, QFormLayout::LabelRole, is_capture_label);
        ...
        formLayout->setWidget(2, QFormLayout::FieldRole, is_capture_lineEdit);
        ...
        formLayout->setWidget(3, QFormLayout::LabelRole, possible_moves_count_label);
        ...
        formLayout->setWidget(3, QFormLayout::FieldRole, possible_moves_count_lineEdit);
        ...
        formLayout->setWidget(4, QFormLayout::LabelRole, unopposed_threats_white_label);
        ...
        formLayout->setWidget(4, QFormLayout::FieldRole, unopposed_threats_white_lineEdit);
        ...
        formLayout->setWidget(5, QFormLayout::LabelRole, unopposed_threats_black_label);
