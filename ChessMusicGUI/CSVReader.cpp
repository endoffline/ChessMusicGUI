...
Models::Game CSVReader::loadGame() {
	...
	while (std::getline(file, line))
	{
		...
		Models::Move move(
			...
			lineValues[33],
			std::stoi(lineValues[34]),
			lineValues[35],
			std::stoi(lineValues[36]),
			lineValues[37],
			std::stoi(lineValues[38]),
			lineValues[39],
			std::stoi(lineValues[40]),
			std::stoi(lineValues[41]),
			std::stoi(lineValues[42]),
			std::stoi(lineValues[43]),
			std::stoi(lineValues[44]),
